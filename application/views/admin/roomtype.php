                                        ...
                                        <div class="datatable-wrapper table-responsive">
                                            <table id="data_table" class="display compact table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $no = 1;
                                                    foreach ($type_room as $tr) { ?>
                                                        <tr>
                                                            <td><?php echo $no++ ?></td>
                                                            <td><?php echo $tr->nama_tipekamar ?></td>
                                                            <td>
                                                                <a onclick="edit_type('<?php echo $tr->id_tipekamar ?>')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
                                                                ...
                                                                <a onclick="delete_message('<?php echo $tr->id_tipekamar ?>','<?php echo base_url(); ?>admin/roomtype/delete','<?php echo base_url(); ?>admin/roomtype')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
