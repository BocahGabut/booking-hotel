...
<body class="light-sidebar">
    ...
    <div class="app">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($fact as $tr) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a onclick="edit('<?php echo $tr->id_fasilitas ?>')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
                                                                ...
                                                                <a onclick="delete_message('<?php echo $tr->id_fasilitas ?>','<?php echo base_url(); ?>admin/facility/delete','<?php echo base_url(); ?>admin/facility')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
        ...
        <?php
        $this->load->view('admin/modal/facility_modal');
        ...
        <script>
            function edit(id) {
                $.ajax({
                    url: "<?php echo base_url(); ?>admin/facility/edit",
                    type: "post",
                    data: {
                        id: id
                    },
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            $('#edit').modal('show');
                            document.getElementById("id_fasilitas").value = '' + data[i].id_fasilitas;
                            document.getElementById("nama_fasilitas").value = '' + data[i].nama_fasilitas;
                        }
                    }
                });
            }
