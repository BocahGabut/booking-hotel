...
<body class="light-sidebar">
    ...
    <div class="app">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($price as $tr) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $tr->persentase . ' %' ?></td>
                                                            <td><?php echo $tr->tgl_mulai . ' -> ' . $tr->tgl_selesai ?></td>
                                                            <td>
                                                                <a onclick="edit_type('<?php echo $tr->id_diskon ?>')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
                                                                ...
                                                                <a onclick="delete_message('<?php echo $tr->id_diskon ?>','<?php echo base_url(); ?>admin/diskonprice/delete','<?php echo base_url(); ?>admin/diskonprice')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
        ...
        <?php
        $this->load->view('admin/modal/diskon_modal');
        ...
        <script>
            function edit_type(id) {
                $.ajax({
                    url: "<?php echo base_url(); ?>admin/diskonprice/edit",
                    type: "post",
                    data: {
                        id: id
                    },
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            $('#edit').modal('show');
                            document.getElementById("id").value = '' + data[i].id_diskon;
                            document.getElementById("type").value = '' + data[i].id_tipekamar;
                            document.getElementById("percen").value = '' + data[i].persentase;
