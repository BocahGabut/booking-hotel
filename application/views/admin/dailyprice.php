...
<body class="light-sidebar">
    ...
    <div class="app">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($price as $tr) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo number_format($tr->harga_kamar) ?></td>
                                                            <td><?php echo $tr->pajak . ' %' ?></td>
                                                            <td>
                                                                <a onclick="edit_type('<?php echo $tr->id_hargakamar ?>')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
                                                                ...
                                                                <a onclick="delete_message('<?php echo $tr->id_hargakamar ?>','<?php echo base_url(); ?>admin/dailyprice/delete','<?php echo base_url(); ?>admin/dailyprice')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
        ...
        <?php
        $this->load->view('admin/modal/daily_modal');
        ...
        <script>
            function edit_type(id) {
                $.ajax({
                    url: "<?php echo base_url(); ?>admin/dailyprice/edit",
                    type: "post",
                    data: {
                        id: id
                    },
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            $('#edit').modal('show');
                            document.getElementById("id").value = '' + data[i].id_hargakamar;
